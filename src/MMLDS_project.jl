...
#github link for NODEData: https://github.com/maximilian-gelbrecht/NODEData.jl.git
    ...
    export create_data, train_SINDy, hyperOpt, generate_esn, train_val_test_split, ESNHyperparams, cross_validate_esn, compress_data_matrix, save_NODE, load_NODE, plot_lyapunov_exp, plot_SINDy_and_ElNino_trajectories, MSE_on_lyapunov_time
